...
shop.display_menu()                                         # Why am i not storing it in a variable here? Answer here _Because display_menu() only displays/prints the menu and does not return a value. Therefore, there is nothing useful to store in a variable.________________________
